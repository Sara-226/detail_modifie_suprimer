...
function returnTd (arr) {
  ...
  arr.forEach(obj => {
    ...
    <tr>
      ...
      <td>${obj.sexe}</td>
      <td>${obj.formation}</td>
      <td><a href="details.php?id=${obj.details}">Plus...</a></td>
      <td><a href="modification.php?id=${obj.modifier}">modifier</a></td>
      <td><a href="Delete.php?id=${obj.suprimer}">suprimer</a></td>
    </tr>
    `;
  });
  return toDisplay;
